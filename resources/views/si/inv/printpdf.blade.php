...
<div id="header">
    ...
    <table  border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
      ...
      <tr style="border-left:0.1px solid black;border-right:0.1px solid black;border-top:0.1px solid black;">
        <td colspan="2" style="text-align:center; font-size: 16px;font-weight: bold;padding: 3px;border-left:0.1px solid black;"> 
            <strong>{{ HelperSi::FormatInvSi($hd->kd_inv,$hd->jenis) }}</strong><br>
        </td>        
      </tr>
  ...
  <table style="width: 100%;" cellpadding="0" cellspacing="0">
    <tr>
      <th style="width: 25%;padding: 10px;border-left: 0.1 solid black;">Marks & Number</th>
      <th>Keterangan</th>
      <th style="width: 23%;border-right: 0.1 solid black;">Jumlah (Rp.)</th>
    </tr>
   </table>
</div>
<table style="width: 100%;border: 0.1px solid black;" cellpadding="0" cellspacing="0">
     ...
     <tr>
       <td style="width: 25%;padding: 10px;" valign="top">

         <table style="width: 100%;" cellpadding="0" cellspacing="0">
           <tr>
             <td style="padding-left: 5px;padding: 10px;">
                  <p></p>
                  @php
