    ...
    <div class="col-sm-11">
      <div class="widget-box widget-color-blue2">
            <div class="widget-header widget-header-flat">
               <h4 class="widget-title">Create Invoice :: Vessel  </h4>
            ...
            <div class="widget-body">
               <div class="widget-main">
                ...
                <form action="{{ route('wh.container.storenew',[$cont]) }}" method="post" class="form-horizontal">
                  @csrf
                     ...
                     <div class="widget-toolbar">
                        ...
                        <div class="btn-group">
                           ...
                           <ul class="dropdown-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret">                            
                              <li>
                                  <a href="{{ route('vessel.invcntnewpdf',[$cont]) }}" 
                                    onclick="event.preventDefault();
                                       document.getElementById('print-pdf').submit();" 
                                       >Print PDF</a>
                                    <form  id="print-pdf" action="{{ route('vessel.invcntnewpdf',[$cont]) }}" method="POST">
                                       @csrf      
                        ...
                        <table class="table table-bordered">
                             ...
                             <div class="inline position-relative">
                                 ...
                                 <ul class="dropdown-menu dropdown-yellow dropdown-menu-right">
                                     <li>
                                        <a href="{{ route('vessel.container_edit',[$cont,$dtl->id]) }}">Edit</a> 
                                     </li><li>
                                        <a href="{{ route('vessel.container_delete',[$cont,$dtl->id]) }}">Delete</a> 
                                     </li>
