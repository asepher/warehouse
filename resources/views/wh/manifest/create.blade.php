		...
		<hr>
			...
			<div class="widget-box widget-color-blue2">
				<div class="widget-header widget-header-flat">
					<h5 class="widget-title">Entry Detail Manifest</h5>			
				</div>
			...
			@php
				$seq = $vessel->last_num+1;
			@endphp
			<form class="form-horizontal"  role="form" action="{{ route('wh.manifest.store',[$vsl])}}" method="post">
			{{ csrf_field() }}		    
			<input type="hidden" name="kd_vsl" value="{{ $vsl }}" />

				<div class="form-group">
					<label class="control-label col-sm-2"><strong>Seq</strong></label>
					<div class="col-sm-1">
						<input type="number" name="seq" value="{{ $vessel->last_num+1 }}" readonly>
					</div>
              ...
              @endif
				...
				<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="bill_to" class="chosen-select" >
									<option value="" > -- Pilih -- </option>	
...
<div class="hr hr-16 hr-dotted"></div>
			    		...
			    		<div class="form-group">
				              ...
				              <div class="col-sm-2">          
					              <input type="text" name="weight" placeholder="Entr Weight" value="{{ old('weight') }}" style="text-align: right;"
					              class="form-control" autocomplete="off" />
			    		...
			    		<div class="form-group">
				              ...
				              <div class="col-sm-2">
					              <input type="text" name="measure" placeholder="Entry Measure" value="{{ old('measure') }}" style="text-align: right;"
					              class="form-control" autocomplete="off" />
