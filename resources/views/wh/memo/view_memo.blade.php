...
@section('content')
 ...
 @if ($manifest->term == 'CNF' && $manifest->gen_inv == 0 )
	...
	<div class="row">		
		<div class="col-xs-11">
			<div class="widget-box widget-color-blue2">
				...
				<div class="widget-body">
					<div class="widget-main">
														...
														@php
															$sw = 0;
														@endphp
								<form class="form-horizontal" role="form" action="{{ route('wh.memo.generate-memo',[$nominv]) }}"
										method="post">					
										{{ csrf_field() }}
				...
				@if ($manifest->gen_memo == 1 || $manifest->gen_inv == 0)
						Disabled 										
				@endif
															 >
														</div>
