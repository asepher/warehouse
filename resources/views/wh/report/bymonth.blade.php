...
@section('breadcrumb')
    <a href="{{ route('wh.manifest.bycontainer') }}">Invoice</a>
@endsection
...
<form class="form-horizontal" role="form" action="{{ route('wh.invoice.qbymonth') }}" method="post">
                     {{ csrf_field() }}
...
<div class="form-group">
                        ...
                        <div class="col-md-3">
                            <select name="dtquery" id="" class="form-control">
                               <option value="">--Pilih--</option>
