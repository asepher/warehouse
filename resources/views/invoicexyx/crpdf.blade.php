    ...
    <table border="0">
      ...
      <tr>
        ...
        @if ($manifest->term == 'FOB' )
            <td colspan="2" style="text-align:center;font-size:17px;font-weight: bold;"><strong>NOMINASI</strong></td>  
        @endif
    ...
    <table id="item" style="width: 65%;">
      ...
      <tbody>
        ...
        @foreach ($tarif as $trf)
          ...
          <tr>
            ...
            <td style="border: 1px solid; text-align: center;">{{ Rupiah($trf->jumlah) }}</td>
            <td style="border: 1px solid; text-align: center;">{{ $min }}</td>
            <td style="border: 1px solid;text-align: right;">{{ Rupiah($jumlah) }}</td>
          </tr>
        @endforeach   
        @for ($i = $brs; $i < 7 ; $i++)
          <tr>
      ...
      @php
        ...
        <tr>
            ...
            <td style="border: 1px solid black;text-align:right;font-size:17px;font-weight: bold;">{{ Rupiah($totsub) }}</td>
          </tr>
          <tr>
            <td colspan="4" style="text-align:right;font-size:17px;font-weight: bold;">PPN</td>
            <td style="border: 1px solid black;text-align:right;font-size:17px;font-weight: bold;">{{ Rupiah($totppn) }}</td>
          </tr>
          <tr>
            <td colspan="4" style="text-align:right;font-size:17px;font-weight: bold;">Materai</td>
            <td style="border: 1px solid black;text-align:right;font-size:17px;font-weight: bold;">{{ Rupiah($materai) }}</td>
          </tr>
          <tr>
            <td colspan="4" style="text-align:right;font-size:17px;font-weight: bold;">Grand Total </td>
            <td style="border: 1px solid black;text-align:right;font-size:17px;font-weight: bold;">{{ Rupiah($grandtot) }}</td>
          </tr>
    </table>
