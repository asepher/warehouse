     ...
     <script type="text/javascript">
      jQuery(function($) {
            ...
            //datepicker plugin
				...
				$('#vessel-dropdown').on('change',function() {
					var kd_vsl = this.value;
                    ...
                    success: function (result) {
                        $('#container-dropdown').html('<option value="">-- Select Container --</option>');
                        $.each(result.states, function (key, value) {
                            $("#container-dropdown").append('<option value="' + value
